...
DKColorPicker DKColorWithRGBA(NSUInteger normal, NSUInteger night, CGFloat normalA, CGFloat nightA) {
    UIColor *normalColor = [UIColor colorWithRed:((float)((normal & 0xFF0000) >> 16))/255.0 green:((float)((normal & 0xFF00) >> 8))/255.0 blue:((float)(normal & 0xFF))/255.0 alpha:normalA];
    UIColor *nightColor = [UIColor colorWithRed:((float)((night & 0xFF0000) >> 16))/255.0 green:((float)((night & 0xFF00) >> 8))/255.0 blue:((float)(night & 0xFF))/255.0 alpha:nightA];
    return DKColorWithColors(normalColor, nightColor);
}
